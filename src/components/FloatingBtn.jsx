        ...
        <>
            <div className="fixed bottom-5 right-5 z-50">
                <section className="flex flex-col gap-3 duration-300">
                    <button
                        onClick={scrollToTop}
                        className={`${isVisible ? "scale-100 " : 'scale-0 '} bg-mainColor bg-opacity-50 duration-300 backdrop-blur-md hover:bg-secondaryColor text-white rounded-full p-4 shadow-lg`}
                    >
